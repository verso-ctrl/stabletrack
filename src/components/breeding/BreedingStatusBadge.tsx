...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  STILLBORN: { label: 'Stillborn', className: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-400' },
  ABORTION: { label: 'Abortion', className: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
  DYSTOCIA: { label: 'Dystocia', className: 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400' },
