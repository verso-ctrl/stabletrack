    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-stone max-w-none">
          <p className="text-stone-600 mb-8">Last updated: January 2025</p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">5. Payment Terms</h2>
            <p className="text-stone-600 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">6. Data Ownership</h2>
            <p className="text-stone-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">7. Service Availability</h2>
            <p className="text-stone-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">10. Changes to Terms</h2>
            <p className="text-stone-600">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">11. Contact</h2>
            <p className="text-stone-600">
