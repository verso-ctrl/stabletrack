    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-stone max-w-none">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">4. Data Retention</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-stone-900 mb-4">6. Cookies</h2>
            <p className="text-stone-600">
          ...
          <section className="mb-8">
            ...
            <p className="text-stone-600">
              If you have questions about this Privacy Policy, please contact us at privacy@stabletrack.com.
            </p>
          </section>
        </div>
      </div>
