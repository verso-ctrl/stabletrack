...
type RouteContext = { params: Promise<{ barnId: string; horseId: string; noteId: string }> }
...
export async function PATCH(req: NextRequest, context: RouteContext) {
  try {
    ...
    const { barnId, horseId, noteId } = await context.params
    ...
    const note = await prisma.note.findUnique({ where: { id: noteId, horseId } })
