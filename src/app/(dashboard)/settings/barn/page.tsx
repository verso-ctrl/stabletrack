  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage your barn information and preferences</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6">
        {/* Logo */}
        <div className="card p-6">
          <h3 className="font-medium text-foreground mb-4">Barn Logo</h3>
          <div className="flex items-center gap-6">
            <div className="relative">
              <div className="relative w-24 h-24 rounded-2xl bg-muted flex items-center justify-center overflow-hidden">
                {formData.logoUrl ? (
                  <Image src={formData.logoUrl} alt="" fill className="object-cover" unoptimized />
                ) : (
            ...
            <div>
              <p className="text-sm text-muted-foreground">Upload a barn logo</p>
        ...
        <div className="card p-6">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-muted-foreground mb-1">Barn Name</label>
              <div className="relative">
        ...
        <div className="card p-6">
          ...
          <div className="flex items-center gap-3">
            <div className="flex-1 p-4 bg-muted rounded-xl font-mono text-lg tracking-wider">
              {formData.inviteCode}
            </div>
            <button
              type="button"
        ...
        <div className="card p-6 border-red-200">
          ...
          <div className="p-4 rounded-xl bg-red-50">
            <div className="flex items-center justify-between">
              <div>
                <p className="font-medium text-foreground">Delete Barn</p>
                <p className="text-sm text-muted-foreground">Permanently delete this barn and all its data</p>
              </div>
              <button
                type="button"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-card rounded-2xl shadow-xl max-w-md w-full p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Delete Barn?</h3>
